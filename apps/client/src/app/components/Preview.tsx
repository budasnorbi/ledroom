  ...
  useEffect(() => {
    ...
    if (canvasRef.current) {
      ...
      if (ctx) {
        ...
        for (let i = 0; i < 35; i++) {
          ledCoordinatesX[butorKilogasFalRange[0] + i] =
            187 * ledSize + i * ledSize;
        ...
        for (let i = 0; i < 84; i++) {
          if (ajtoFalRange[0] + i >= 900) {
            ledCoordinatesX[i - (900 - 816)] = 187 * ledSize + 35 * ledSize;
            ledCoordinatesY[i - (900 - 816)] = 98 * ledSize + i * ledSize;
          } else {
          ...
          ctx.fillRect(
            187 * ledSize + 35 * ledSize,
            98 * ledSize + i * ledSize,
            ledSize,
            ledSize
          );
        }
        for (let i = 0; i < 222; i++) {
          ledCoordinatesX[agyFalRange[0] + i] =
        ...
        for (let i = 0; i < 182; i++) {
          ...
          ledCoordinatesY[ablakFalRange[0] + i] =
            98 * ledSize + 84 * ledSize - i * ledSize;
